...
export function inspectLocalEntityInventory(): LocalEntityInventory {
  ...
  const fields: LocalEntityField[] = [
    ...
    field({
      ...
      present: true,
      normalizedValue: "Charlotte, NC (Charlotte-based; schema locality Charlotte)",
    ...
    field({
      ...
      present: false,
      normalizedValue: null,
      sourceRouteOrFile: "lib/seo/schema/entities.ts#PostalAddress",
      consistencyStatus: "missing",
      confidence: 0.9,
      sensitivity: "public",
      public: false,
