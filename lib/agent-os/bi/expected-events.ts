...
export const EXPECTED_EVENT_INVENTORY: readonly ExpectedEventDefinition[] = [
  ...
  {
    stableEventId: "expected:studio-snapshot-created",
    expectedEventName: "studio_snapshot_created",
    category: "tool-completion",
    route: "/diamond-studio",
    journey: "diamond-studio",
    funnelStage: "meaningful-interaction",
    triggerDescription: "User generates a clean Studio snapshot (explicit action)",
    sourceReference: "app/diamond-studio/analytics.ts#studio_snapshot_created",
    expectedParameters: [
      "shape",
      "carat",
      "fingerSize",
  ...
  {
    stableEventId: "expected:studio-share-card-created",
    expectedEventName: "studio_share_card_created",
    category: "tool-completion",
    route: "/diamond-studio",
    journey: "diamond-studio",
    funnelStage: "meaningful-interaction",
    triggerDescription: "User generates a branded Studio share card",
    sourceReference: "app/diamond-studio/analytics.ts#studio_share_card_created",
    expectedParameters: [
      "shape",
      "carat",
      "fingerSize",
  ...
  {
    stableEventId: "expected:studio-snapshot-shared",
    expectedEventName: "studio_snapshot_shared",
    category: "tool-completion",
    route: "/diamond-studio",
    journey: "diamond-studio",
    funnelStage: "meaningful-interaction",
    triggerDescription: "User shares a Studio snapshot or card image",
    sourceReference: "app/diamond-studio/analytics.ts#studio_snapshot_shared",
    expectedParameters: [
      "shape",
      "carat",
      "fingerSize",
  ...
  {
    stableEventId: "expected:studio-view-emailed",
    expectedEventName: "studio_view_emailed",
    category: "tool-completion",
    route: "/diamond-studio",
    journey: "diamond-studio",
    funnelStage: "meaningful-interaction",
    triggerDescription:
      "Visitor emails a Studio configuration to themselves after confirmed send (no PII in GA)",
    sourceReference: "app/diamond-studio/analytics.ts#studio_view_emailed",
    expectedParameters: [
      "shape",
      "carat",
      "fingerSize",
