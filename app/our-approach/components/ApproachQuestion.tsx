...
export default function ApproachQuestion({
  ...
  return (
    <details className="group/question border-b border-[rgba(181,150,98,0.14)] last:border-b-0">
      <summary
        className="flex cursor-pointer list-none items-start justify-between gap-4 py-5 text-left transition-colors hover:bg-[rgba(255,255,255,0.12)] md:gap-6 md:py-7 [&::-webkit-details-marker]:hidden"
      ...
      >
        ...
        <span
          className="mt-0.5 grid h-[30px] w-[30px] shrink-0 place-items-center rounded-full border border-[rgba(181,150,98,0.28)] bg-[rgba(181,150,98,0.06)] text-[15px] font-light leading-none text-[#b59662] group-open/question:hidden"
          aria-hidden
        >
          ＋
        </span>
        <span
          className="mt-0.5 hidden h-[30px] w-[30px] shrink-0 place-items-center rounded-full border border-[rgba(181,150,98,0.28)] bg-[rgba(181,150,98,0.06)] text-[15px] font-light leading-none text-[#b59662] group-open/question:grid"
          aria-hidden
        >
          —
        </span>
