...
export default function DiV3ResultSections({
  ...
  const percentile = showPercentile
    ? buildV3PercentilePresentation(
        ...
        decisionProfile.gradeHints.clarity,
      )
    : null;
  ...
  const displayTier = displayV3PublicTierLabel(publicTier);

  const technicalItems: { label: string; value: string }[] = isGcal8x
    ? [
        { label: "Assessment Context", value: "GCAL 8X Class" },
        { label: "Assessment Tier", value: gcal8xTier ?? "—" },
    ...
    : [
        { label: "Assessment Tier", value: displayTier },
        ...(clarityPolicy.isExcluded
          ? [{ label: "Hourglass Standards", value: "Outside Standards" }]
          : percentile
            ? [{ label: "Percentile", value: percentile.topLine }]
            : []),
        {
          label: "Overall Recommendation",
          value: decisionProfile.overallRecommendation.band,
        },
        {
        ...
        note={
          clarityPolicy.isExcluded
            ...
            : isGcal8x
              ...
              : "The full tier ladder and why this stone lands here."
        }
