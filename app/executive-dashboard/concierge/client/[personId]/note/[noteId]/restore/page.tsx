...
import { ConfirmNoteLifecycleForm } from "../../../../../components/confirm-note-lifecycle-form";
...
export default async function ConciergeRestoreNotePage({
  params,
  searchParams,
}: {
