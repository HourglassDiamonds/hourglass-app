...
import { AddOpenJobForm } from "../../../../components/add-open-job-form";
...
export default async function ConciergeAddOpenJobPage({
  params,
}: {
  ...
  if (!desk.desk.openJobs.connected) {
    return (
      <ConciergeShell>
        <Link
        ...
        <div className="hg-concierge-fade mt-8">
          ...
          <p className="mt-4 max-w-[42ch] text-[15px] leading-relaxed text-[#c4b7aa]">
            Open Jobs are not connected yet.
          </p>
        </div>
      </ConciergeShell>
    );
