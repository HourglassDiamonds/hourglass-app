...
import { allArticleGroups } from "../content";

export default function ProposalPlanningAllPage() {
  return (
        ...
        <section className="border-b border-[#e4dbcf] pb-[70px] pt-[80px] md:pb-[90px] md:pt-[95px]">
          <div className="mx-auto max-w-[720px] text-center">
            ...
            <h1 className="mt-5 text-[2.2rem] tracking-[-0.045em] md:text-[3rem]">
              All proposal planning guides.
            </h1>

            <p className="mx-auto mt-6 max-w-[600px] text-[1rem] leading-[1.85] text-[#6f675f]">
              A complete set of guides covering Charlotte proposal locations,
              planning the moment, photographers, celebration dinners, and the
              first days after you are engaged.
            </p>
          </div>
        </section>
        ...
        <RevealOnScroll as="section" className="pb-[110px] pt-[40px]">
          <div className="mx-auto max-w-[700px] text-center">
            ...
            <p className="mt-5 leading-[1.8] text-[#6f675f]">
              A memorable proposal usually comes from thoughtful preparation,
            ...
            <div className="mt-8">
              <CTAGlimmer>
                <ConsultationCtaLink
                  location="guide_hub:proposal_planning_all"
                  tool="diamond-guide"
